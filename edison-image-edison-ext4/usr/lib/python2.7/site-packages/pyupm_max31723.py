...
_pyupm_max31723.HIGH_swigconstant(_pyupm_max31723)
HIGH = _pyupm_max31723.HIGH

_pyupm_max31723.LOW_swigconstant(_pyupm_max31723)
LOW = _pyupm_max31723.LOW
class MAX31723(_object):
    """Proxy of C++ upm::MAX31723 class"""
    __swig_setmethods__ = {}
    ...
    def __init__(self, csn):
        ...
        """
        this = _pyupm_max31723.new_MAX31723(csn)
        try:
