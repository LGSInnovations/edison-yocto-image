...
class MPR121(_object):
    ...
    def writeBytes(self, reg, buffer, len):
        """
        writeBytes(MPR121 self, uint8_t reg, uint8_t * buffer, unsigned int len) -> mraa_result_t
    ...
    def readBytes(self, reg, buffer, len):
        """
        readBytes(MPR121 self, uint8_t reg, uint8_t * buffer, unsigned int len)
