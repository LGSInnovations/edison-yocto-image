...
class MQ303A(_object):
    ...
    def __init__(self, pin, heaterPin):
        """
        ...
        """
        this = _pyupm_mq303a.new_MQ303A(pin, heaterPin)
        try:
    ...
    def heaterEnable(self, enable):
        ...
        """
        return _pyupm_mq303a.MQ303A_heaterEnable(self, enable)
