...
def init_local_interfaces(aci, reqn, rdyn, rst):
    """
    ...
    """
    return _pyupm_nrf8001.init_local_interfaces(aci, reqn, rdyn, rst)

def close_local_interfaces(aci):
    """
    ...
    """
    return _pyupm_nrf8001.close_local_interfaces(aci)
