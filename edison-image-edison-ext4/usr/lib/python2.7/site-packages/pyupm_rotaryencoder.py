...
class RotaryEncoder(_object):
    """Proxy of C++ upm::RotaryEncoder class"""
    __swig_setmethods__ = {}
    ...
    def __init__(self, pinA, pinB):
        ...
        """
        this = _pyupm_rotaryencoder.new_RotaryEncoder(pinA, pinB)
        try:
    ...
    def signalAISR(ctx):
        ...
        """
        return _pyupm_rotaryencoder.RotaryEncoder_signalAISR(ctx)

    if _newclass:
        signalAISR = staticmethod(signalAISR)
    __swig_getmethods__["signalAISR"] = lambda x: signalAISR
RotaryEncoder_swigregister = _pyupm_rotaryencoder.RotaryEncoder_swigregister
RotaryEncoder_swigregister(RotaryEncoder)

def RotaryEncoder_signalAISR(ctx):
    """
    RotaryEncoder_signalAISR(void * ctx)
