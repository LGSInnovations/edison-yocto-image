...
_pyupm_servo.MAX_PERIOD_swigconstant(_pyupm_servo)
MAX_PERIOD = _pyupm_servo.MAX_PERIOD
...
class Servo(_object):
    ...
    def __init__(self, pin):
        this = _pyupm_servo.new_Servo(pin)
        try:
    ...
    def setMaxPeriod(self, width):
        return _pyupm_servo.Servo_setMaxPeriod(self, width)
    ...
    def getMaxPeriod(self):
        return _pyupm_servo.Servo_getMaxPeriod(self)
